...
abbreviation = {
    ...
    'Parbhani': 'F',  # 512
    'Nanded': 'M'  # 586
}  # delete if inputs are given accordingly
...
start_node = ret_value(input("\nEnter the starting node: "), abbreviation)  # Amravati, if input given then delete abbreviations
destn_node = ret_value(input("Enter the destination node: "), abbreviation)  # Mumbai
...
# print("Path from " + f'{start_node}' + " to "+ f'{start_node}' + ": " + path)
print('Cost = ', cost)
